...
const ItinerarySection = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (scrollY > elementPosition - windowHeight + 1800) {
        setIsVisible(true);
      } else {
        setIsVisible(false);
      }
  ...
  return (
    <div className={`min-h-screen pt-14 md:pt-24 ${isVisible ? "opacity-100 transition duration-1000 ease-in-out" : "opacity-0"}`} id="itinerary">
