...
const SponsorsSection = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (scrollY > elementPosition - windowHeight + 2500) {
        setIsVisible(true);
      } else {
        setIsVisible(false);
      }
  ...
  return (
    <div className={`${isVisible ? "opacity-100 transition duration-1000 ease-in-out" : "opacity-0"} min-h-screen pt-14 md:pt-24 `} id="sponsors">
